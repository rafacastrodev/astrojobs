...
import { keyboardModifiers } from '../chunk/CUZKAGZ3.js';
import { createComponent, Portal, ssr, ssrAttribute, escape, ssrStyle, ssrStyleProperty, ssrElement, mergeProps } from 'solid-js/web';
import { createSignal, onMount, createEffect, onCleanup, Show, createMemo, untrack, For, useContext, Index } from 'solid-js';
...
var [collapsed, setCollapsed] = createSignal(false);
var createCollapsed = () => ({
...
var stylesFactory = (theme) => {
  ...
  return {
     ...
     */
    workbenchSecondaryTabs: (collapsed2) => css2`
      display: flex;
      align-items: center;
      gap: ${semantic.gap.tight};
      min-width: 0;
      box-sizing: border-box;
      padding-block: ${collapsed2 ? "0px" : "6px"};
      ...
      height: ${collapsed2 ? 0 : PLUGINS_STRIP_HEIGHT}px;
      min-height: 0;
      flex: 0 0 auto;
      opacity: ${collapsed2 ? 0 : 1};
      /* Chrome band: the strip belongs to the header, not to the canvas. */
      background: ${semantic.color.surface.brand};
      border-bottom: ${collapsed2 ? "0" : "1px"} solid
        ${semantic.color.state.pressed};
      overflow-x: ${collapsed2 ? "hidden" : "auto"};
      overflow-y: hidden;
      white-space: nowrap;
  ...
  return createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$22, ssrAttribute("class", escape(buttonStyle(), true), false), ssrStyle(isFloating() && coords() ? {
        ...
        get fallback() {
          return createComponent(TanStackEmblem, {});
        },
        get children() {
          return ssr(_tmpl$3);
        }
...
var _tmpl$5 = ["<div", ' data-testid="tanstack-devtools-panel"', ' data-tsd-surface style="', '"', '><div data-testid="devtools-drawer-content"', ">", "</div>", "</div>"];
var MainPanel = (props) => {
  const styles = createStyles();
  const {
    height
...
var ContentPanel = (props) => {
  ...
  return ssr(_tmpl$6, ssrAttribute("class", escape(styles().devtoolsPanel, true), false), ssrStyleProperty("flex-direction:", "column"), props.handleDragStart && pip().pipWindow === null ? ssr(_tmpl$24, ssrAttribute("class", escape(styles().dragHandle(settings().panelLocation), true), false), ssrAttribute("aria-valuemin", escape(PANEL_CLOSE_THRESHOLD, true), false) + ssrAttribute("aria-valuemax", escape(maxHeight(), true), false) + ssrAttribute("aria-valuenow", escape(clampedHeight(), true), false)) : escape(null), escape(props.children));
};
var _tmpl$7 = ["<div", "><h4", ">", "</h4><p", ">", "</p><div", ">", "</div>", "<p", ">Final shortcut is <kbd", ">", "</kbd></p></div>"];
...
var _tmpl$8 = ["<div", ">", "", "", "", "</div>"];
var _tmpl$25 = ["<div", ">", "</div>"];
var _tmpl$33 = ["<div", ">", "", "</div>"];
var _tmpl$42 = ["<div", ">", "<div", ">", "", "</div></div>"];
var _tmpl$52 = ['<div data-testid="settings-workspace" data-tsd-surface style="', '">', "</div>"];
var SettingsTab = () => {
  const {
    setSettings,
    settings
    ...
    get children() {
      return [createComponent(Section, {
        get children() {
          ...
          }), ssr(_tmpl$8, ssrAttribute("class", escape(styles().settingsGroup, true), false), escape(createComponent(Checkbox, {
            label: "Default open",
...
var _tmpl$34 = ["<span", ">v", " \u2022 min v", "</span>"];
var _tmpl$43 = ["<p", ">", "</p>"];
var _tmpl$53 = ["<a", ' target="_blank" rel="noopener noreferrer"', ">Documentation ", "</a>"];
var _tmpl$62 = ["<div", ">", "</div>"];
var _tmpl$72 = ['<div data-tsd-surface class="', '" style="', '"><span', ">", '</span><div class="', '">', "</div><div", "><h3", ">", "", "</h3><p", ">", "</p><p", ">", "</p>", "", "", "</div>", "</div>"];
var _tmpl$82 = ["<span", ">v", " \u2022 requires v", "+</span>"];
var _tmpl$92 = ["<span", ">", "</span>"];
var _tmpl$0 = ["<div", "></div>"];
var _tmpl$1 = ["<span", ">Installing...</span>"];
var _tmpl$10 = ["<span", ">Installed!</span>"];
var _tmpl$11 = ["<div", ' role="status">', "", "", "</div>"];
var PluginCardComponent = (props) => {
  ...
  return ssr(_tmpl$72, `${escape(styles().pluginMarketplaceCard || "", true)} ${!card.isCurrentFramework && card.actionType !== "already-installed" ? escape(escape(styles().pluginMarketplaceCardDisabled, true), true) : ""} ${!!card.metadata?.featured && card.actionType !== "already-installed" ? escape(escape(styles().pluginMarketplaceCardFeatured, true), true) : ""} ${card.actionType === "already-installed" ? escape(escape(styles().pluginMarketplaceCardActive, true), true) : ""}`, ssrStyleProperty("position:", "relative"), ssrAttribute("class", escape(getBadgeClass(card, styles), true), false), escape(getBadgeText(card)), `${escape(styles().pluginMarketplaceCardIcon || "", true)} ${!!card.metadata?.logoUrl ? "custom-logo" : ""}`, escape(createComponent(Show, {
    ...
    get children() {
      return ssr(_tmpl$9, ssrAttribute("src", escape(card.metadata?.logoUrl, true), false) + ssrAttribute("alt", escape(card.metadata?.title || card.devtoolsPackage, true), false) + ssrAttribute("class", escape(styles().pluginMarketplaceCardImage, true), false));
    }
    ...
    get children() {
      return ssr(_tmpl$62, ssrAttribute("class", escape(styles().pluginMarketplaceCardTags, true), false), escape(createComponent(For, {
        ...
        children: (tag) => ssr(_tmpl$92, ssrAttribute("class", escape(styles().pluginMarketplaceCardTag, true), false), escape(tag))
      })));
    }
  })), escape(createComponent(Show, {
    get when() {
    ...
    get fallback() {
      return ssr(_tmpl$11, ssrAttribute("class", escape(styles().pluginMarketplaceCardStatus, true), false), escape(createComponent(Show, {
        ...
        get children() {
          return [createComponent(XCircleIcon, {}), ssr(_tmpl$92, ssrAttribute("class", escape(styles().pluginMarketplaceCardStatusTextError, true), false), escape(card.error || "Failed to install"))];
        }
      })));
    },
    get children() {
...
var _tmpl$13 = ["<div", ' data-tsd-surface role="dialog" aria-label="Marketplace settings"><div', "><h3", '>Marketplace Settings</h3><button type="button" aria-label="Close marketplace settings" data-tsd-control', ">", "</button></div><div", ">", "</div></div>"];
...
var _tmpl$28 = ['<button type="button" data-tsd-control', ' class="', '">', "</button>"];
...
var _tmpl$15 = ["<div", "><div", "><div", "><h2", ">Plugin Marketplace</h2><p", '>Discover and install devtools for TanStack Query, Router, Form, and Pacer</p></div><div data-testid="marketplace-controls"', "><div", ">", '<input type="text" aria-label="Search plugins" data-tsd-control', ' placeholder="Search plugins..."', '></div><button type="button" aria-label="Marketplace settings" data-tsd-control', ">", "</button></div></div>", "</div>"];
...
var _tmpl$29 = ["<div", ' data-testid="plugin-marketplace" data-tsd-surface><div', ">", "", "", "</div>", "</div>"];
...
var _tmpl$17 = ["<div data-tsd-surface", ">", "</div>"];
var PluginsTab = () => {
  const {
    plugins
  } = createPlugins();
...
var _tmpl$18 = ["<div", "><div", ' data-testid="social-preview-heading"><span aria-hidden="true"', ' style="', '"></span>', " Preview</div>", "<div", ' data-testid="social-preview-title">', "</div><div", ">", "</div><div", ">", "</div></div>"];
var _tmpl$210 = ["<img", ' alt="Preview"', ">"];
...
var _tmpl$19 = ["<div", "><div", ' data-testid="serp-preview-label">', "</div><div", "><div", ">", "<div", "><span", ' data-testid="serp-preview-site-name">', "</span><span", ">", "</span></div></div><div", ' data-testid="serp-preview-title">', "</div>", "", "</div>", "</div>"];
var _tmpl$211 = ["<img", ' alt="favicon icon"', ">"];
var _tmpl$37 = ["<div", "></div>"];
var _tmpl$46 = ["<div", ">", "</div>"];
var _tmpl$56 = ["<div", "><strong>Issues for ", ":</strong><ul", ">", "</ul></div>"];
var _tmpl$64 = ["<li", ">", "</li>"];
...
var _tmpl$20 = ['<div data-testid="seo-workspace" data-tsd-surface', ">", "", "</div>"];
var SeoTab = () => {
...
var _tmpl$21 = ["<div", ' data-testid="', '" role="group" aria-label="Panes in this group"', ' style="', '">', "</div>"];
var _tmpl$212 = ['<button type="button" data-tsd-group-tab data-testid="', '" data-tsd-control', ">", "</button>"];
var _tmpl$38 = ["<span", ">", '<button type="button" aria-label="', '" data-testid="', '" data-tsd-control', ">", "</button></span>"];
var _tmpl$47 = ['<div data-testid="plugins-empty-state" data-tsd-surface', ' style="', '"><span aria-hidden="true"', ">", "</span><p", ">No plugin open</p><p", ">Pick a plugin from the strip above to open its panel. You can keep up to ", " open, split side by side or stacked as tabs.</p></div>"];
var _tmpl$57 = ['<div data-testid="plugins-workspace" data-tsd-surface', ' style="', '">', "", "", '<p aria-live="polite" data-testid="plugin-workspace-status"', ">", '</p><p id="tsd-pane-move-hint"', ">Press Enter to pick this pane up and move it with the arrow keys.</p>", "</div>"];
var _tmpl$65 = ['<div id="', '" data-plugin-mount data-testid="', '" data-tsd-surface', ' style="', '"></div>'];
var _tmpl$74 = ['<div role="separator" tabindex="0" data-tsd-control data-tsd-separator="plugin-pane" data-testid="plugin-splitter"', ' aria-label="Resize plugin panes" aria-valuemin="0" aria-valuemax="100"', ' style="', '"></div>'];
var _tmpl$83 = ['<div data-testid="plugin-drop-overlay"', ' style="', '"></div>'];
var _tmpl$93 = ['<span aria-hidden="true" data-testid="plugin-drag-preview"', ' style="', '">', "</span>"];
...
var GroupTabBar = (props) => {
  ...
  return ssr(_tmpl$21, ssrAttribute("data-tsd-group-tabs", escape(props.groupId, true), false), `plugin-group-tabs-${escape(props.groupId, true)}`, ssrAttribute("class", escape(styles().pluginGroupTabs, true), false), ssrStyleProperty("position:", "absolute") + ssrStyleProperty(";left:", `${escape(props.rect?.left ?? 0, true)}px`) + ssrStyleProperty(";top:", `${escape(props.rect?.top ?? 0, true)}px`) + ssrStyleProperty(";width:", `${escape(props.rect?.width ?? 0, true)}px`), escape(createComponent(For, {
    ...
    children: (tabId, index) => ssr(_tmpl$38, ssrAttribute("class", escape(styles().pluginGroupTabItem, true), false) + ssrAttribute("data-tsd-selected", index() === props.activeIndex ? "true" : escape(void 0, true), false) + ssrAttribute("data-tsd-held", props.heldTabId === tabId ? "true" : escape(void 0, true), false), ssrElement("span", mergeProps(() => sortable.row(tabId), {
      get ["class"]() {
        return styles().pluginGroupTabRow;
      }
    }), ssr(_tmpl$212, `plugin-tab-${escape(tabId, true)}`, ssrAttribute("aria-pressed", escape(index(), true) === escape(props.activeIndex, true), false) + ssrAttribute("aria-describedby", escape(props.moveHintId, true), false) + ssrAttribute("class", escape(styles().pluginGroupTab, true), false), escape(props.titleOf(tabId))), false), `Close ${escape(props.titleOf(tabId), true)}`, `plugin-tab-close-${escape(tabId, true)}`, ssrAttribute("class", escape(styles().pluginGroupTabClose, true), false), escape(createComponent(X, {
      "aria-hidden": "true"
    })))
  })));
};
var PluginWorkspace = (props) => {
  ...
  const groupRects = createMemo(() => layoutRects(layout(), box(), PLUGIN_SPLITTER_SIZE));
  const handles = createMemo(() => splitterHandles(layout(), box(), PLUGIN_SPLITTER_SIZE));
  ...
  const resolveTarget = (groupId, point) => {
    ...
    const willStack = zone === "center" || !canSplit(layout(), groupId, zone, MIN_PANE_SIZE, box(), PLUGIN_SPLITTER_SIZE);
    return {
      groupId,
      zone,
      willStack
  ...
  return ssr(_tmpl$57, ssrAttribute("data-tsd-dragging", held() ? "true" : escape(void 0, true), false) + ssrAttribute("class", escape(styles().pluginWorkspace, true), false), ssrStyleProperty("display:", props.visible ? "block" : "none"), escape(createComponent(Show, {
    ...
    get children() {
      return [createComponent(For, {
        ...
        children: (handle) => ssr(_tmpl$74, ssrAttribute("aria-orientation", handle().dir === "row" ? "vertical" : "horizontal", false), ssrAttribute("aria-valuenow", escape(Math.round((handle().dir === "row" ? handle().rect.left : handle().rect.top) / Math.max(handle().extent, 1) * 100), true), false) + ssrAttribute("class", escape(styles().pluginSplitter(handle().dir), true), false), ssrStyleProperty("left:", `${escape(handle().rect.left, true)}px`) + ssrStyleProperty(";top:", `${escape(handle().rect.top, true)}px`) + ssrStyleProperty(";width:", `${escape(handle().rect.width, true)}px`) + ssrStyleProperty(";height:", `${escape(handle().rect.height, true)}px`))
      })];
    }
  })), escape(createComponent(Show, {
    get when() {
    ...
    children: (at) => (
      ...
      createComponent(Portal, {
        ...
        get children() {
          return ssr(_tmpl$93, ssrAttribute("class", escape(styles().pluginDragPreview, true), false), ssrStyleProperty("left:", `${escape(at().x, true)}px`) + ssrStyleProperty(";top:", `${escape(at().y, true)}px`), escape(titleOf(held()?.tabId ?? "")));
        }
      })
    )
    ...
    get children() {
      return ssr(_tmpl$47, ssrAttribute("class", escape(styles().pluginsEmptyState, true), false), ssrStyleProperty("position:", "absolute") + ssrStyleProperty(";inset:", "0"), ssrAttribute("class", escape(styles().pluginsEmptyStateIcon, true), false), escape(createComponent(PackageIcon, {})), ssrAttribute("class", escape(styles().pluginsEmptyStateTitle, true), false), ssrAttribute("class", escape(styles().pluginsEmptyStateHint, true), false), escape(MAX_ACTIVE_PLUGINS));
    }
  })));
};

// src/components/tab-content.tsx
var _tmpl$30 = ["<div", ' data-tsd-surface style="', '">', "", "</div>"];
var TabContent = (props) => {
  ...
  })), props.showMarketplace ? escape(createComponent(PluginMarketplace, {})) : escape(component()?.({
    isOpen: props.isOpen
  })));
};
...
var _tmpl$39 = ['<header aria-label="TanStack Devtools" data-testid="workbench-header" data-tsd-surface', '><span data-testid="workbench-logo" aria-hidden="true"', ">", '</span><strong data-testid="workbench-wordmark" class="', '">TanStack Devtools</strong><nav aria-label="Workbench destinations" data-testid="workbench-destinations"', ">", "</nav><span", '><button type="button" aria-label="Settings" title="Settings" data-testid="tsd-tab-settings" data-tsd-control', ' data-icon="cogs"', ">", "</button>", "</span></header>"];
var _tmpl$214 = ['<button type="button" data-testid="', '" data-tsd-control', ">", "</button>"];
var _tmpl$310 = ['<button type="button" aria-label="Detach TanStack Devtools" title="Detach into its own window" data-testid="tsd-pip-button" data-tsd-control', ">", "</button>"];
var _tmpl$48 = ['<button type="button" aria-label="Close TanStack Devtools" title="Close TanStack Devtools" data-testid="tsd-close-button" data-tsd-control', ">", "</button>"];
var WorkbenchHeader = (props) => {
  ...
  return ssr(_tmpl$39, ssrAttribute("class", escape(styles().workbenchHeader, true), false), ssrAttribute("class", escape(styles().workbenchLogo, true), false), escape(createComponent(TanStackEmblem, {})), `${escape(styles().workbenchWordmark, true)} tsd-workbench-wordmark`, ssrAttribute("class", escape(styles().workbenchDestinations, true), false), escape(["plugins", "marketplace", "seo"].map((destination) => {
    const label = destination === "seo" ? "SEO" : destination[0].toUpperCase() + destination.slice(1);
    return ssr(_tmpl$214, `tsd-tab-${escape(destination, true)}`, ssrAttribute("class", escape(styles().workbenchNavButton, true), false) + ssrAttribute("data-tsd-selected", isSelected(destination) ? "true" : escape(void 0, true), false) + ssrAttribute("aria-current", isSelected(destination) ? "page" : escape(void 0, true), false), escape(label));
...
var PluginsStrip = (props) => {
  ...
  createEffect((wasEmpty) => {
    ...
    if (isEmpty && wasEmpty === false) setCollapsed2(true);
    if (!isEmpty && wasEmpty === true) setCollapsed2(false);
    return isEmpty;
  });
      ...
      return createComponent(For, {
        ...
        children: (plugin) => {
          ...
          return createComponent(WorkbenchSecondaryTab, {
            ...
            get children() {
              return ssr(_tmpl$40, `${escape(PLUGIN_TITLE_CONTAINER_ID, true)}-${escape(plugin.id, true)}`, ssrStyle(typeof plugin.name === "function" ? {
                all: "initial"
              } : void 0), ssrAttribute("class", typeof plugin.name === "string" ? escape(styles().pluginTitleText, true) : escape(void 0, true), false));
            }
          });
        }
      });
  ...
  return createComponent(ThemeContextProvider, {
    ...
    get children() {
      return createComponent(Portal, {
        ...
        get children() {
          return ssr(_tmpl$41, ssrAttribute("data-testid", escape(TANSTACK_DEVTOOLS, true), false), escape(createComponent(Show, {
            get when() {
