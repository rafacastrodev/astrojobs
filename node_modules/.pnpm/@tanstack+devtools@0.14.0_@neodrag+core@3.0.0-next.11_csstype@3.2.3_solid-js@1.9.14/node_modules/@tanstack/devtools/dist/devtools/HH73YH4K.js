...
var _tmpl$4 = /* @__PURE__ */ template(`<nav data-workbench-secondary-tabs data-tsd-surface>`);
...
var _tmpl$5 = /* @__PURE__ */ template(`<div data-testid=tanstack-devtools-panel data-tsd-surface style=max-inline-size:100%;inset-inline:0px;box-sizing:border-box><div data-testid=devtools-drawer-content>`);
var MainPanel = (props) => {
  const styles = createStyles();
  const {
    height
...
var _tmpl$6 = /* @__PURE__ */ template(`<div data-testid=tanstack-devtools-content-panel data-tsd-surface style=flex-direction:column>`);
...
var _tmpl$7 = /* @__PURE__ */ template(`<div><h4></h4><p></p><div></div><p>Final shortcut is <kbd>`);
...
var HotkeyConfig = (props) => {
  ...
  return (() => {
    var _el$ = _tmpl$7(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$8 = _el$6.nextSibling;
...
var _tmpl$9 = /* @__PURE__ */ template(`<img>`);
...
var PluginWorkspace = (props) => {
  ...
  const startSplitterDrag = (handle, event) => {
    ...
    const move = (moveEvent) => {
      ...
      setLayout(resize(layout(), handle.path, handle.gutterIndex, (now - start) / handle.extent, minFraction));
    };
    const up = () => {
      document.removeEventListener("pointermove", move);
      document.removeEventListener("pointerup", up);
      ...
      get children() {
        return [createComponent(For, {
          ...
          children: (handle) => (() => {
            ...
            effect((_p$) => {
              var _v$28 = handle().dir === "row" ? "vertical" : "horizontal", _v$29 = Math.round((handle().dir === "row" ? handle().rect.left : handle().rect.top) / Math.max(handle().extent, 1) * 100), _v$30 = styles().pluginSplitter(handle().dir), _v$31 = `${handle().rect.left}px`, _v$32 = `${handle().rect.top}px`, _v$33 = `${handle().rect.width}px`, _v$34 = `${handle().rect.height}px`;
...
var _tmpl$31 = /* @__PURE__ */ template(`<header aria-label="TanStack Devtools"data-testid=workbench-header data-tsd-surface><span data-testid=workbench-logo aria-hidden=true></span><strong data-testid=workbench-wordmark>TanStack Devtools</strong><nav aria-label="Workbench destinations"data-testid=workbench-destinations></nav><span><button type=button aria-label=Settings title=Settings data-testid=tsd-tab-settings data-tsd-control data-icon=cogs>`);
var _tmpl$213 = /* @__PURE__ */ template(`<button type=button data-tsd-control>`);
var _tmpl$39 = /* @__PURE__ */ template(`<button type=button aria-label="Detach TanStack Devtools"title="Detach into its own window"data-testid=tsd-pip-button data-tsd-control>`);
...
var WorkbenchHeader = (props) => {
  ...
  return (() => {
    var _el$ = _tmpl$31(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild;
