...
import infrastructure.models  # noqa: F401  (registers every model on Base)
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            compare_type=True,
            # Batch mode keeps generated migrations runnable on SQLite, which
            # cannot ALTER columns or constraints in place.
            render_as_batch=True,
        )
